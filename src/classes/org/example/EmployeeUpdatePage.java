...
public class EmployeeUpdatePage {
    public EmployeeUpdatePage() {
        JFrame frame = new JFrame("Update Employee Info");
        ...
        updateButton.addActionListener((e) -> {
            ...
            try {
                PrintWriter writer = new PrintWriter(new FileWriter("C:\\Users\\benja\\OneDrive\\Desktop\\Courier_Management\\src\\main\\java\\org\\example\\Employee.txt", true));
                writer.println(username + "," + password + "," + name + "," + email + "," + address + "," + phoneNumber);
                writer.close();
