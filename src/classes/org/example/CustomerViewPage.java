...
public class CustomerViewPage {
    public CustomerViewPage() {
        JFrame frame = new JFrame("Customer View Page");
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\benja\\OneDrive\\Desktop\\Courier_Management\\src\\main\\java\\org\\example\\Customer.txt"));
        ...
        loginButton.addActionListener((ex) -> {
        });
